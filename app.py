...
class ThicknessApp:
    ...
    def build_ui(self) -> None:
        ...
        button_font_size = int(15 * self.ui_scale)
        ...
        button_px = max(72, int(min(92 * self.ui_scale, self.screen_width * 0.105)))
        ...
        tk.Label(controls, text="Ref. Thickness", font=label_font, bg=RIBBON_BG, fg=RIBBON_FG).grid(row=0, column=0, sticky="e", padx=(0, small_pad), pady=(0, small_pad))
        ...
        tk.Label(controls, text="Ref. Velocity", font=label_font, bg=RIBBON_BG, fg=RIBBON_FG).grid(row=1, column=0, sticky="e", padx=(0, small_pad))
